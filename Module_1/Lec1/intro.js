...
// to run a file into terminal use ->  node filename.js
// to go into a particular folder write -> cd folderName   in terminal
// to come out of a particular folder write -> cd  .. in termonal
// to open terminal use esc+backtick

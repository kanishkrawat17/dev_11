...
let lockButton = document.querySelector(".ticket-lock");
...
function appendTicket(ticketInfoObject) {
  ...
  ticketDiv.innerHTML = `<div class="ticket-header ${ticketFilter}"></div>
    <div class="ticket-content">
        <div class="ticket-info">
            ...
            <div class="ticket-lock fa fa-lock "> </div>
  ...
  ticketDiv.querySelector(".ticket-lock").addEventListener("click",lockTicketButton);
